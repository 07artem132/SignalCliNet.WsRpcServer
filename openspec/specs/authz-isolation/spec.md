# authz-isolation Specification

## Purpose
TBD - created by archiving change add-authz-chokepoint. Update Purpose after archive.
## Requirements
...
#### Scenario: несумісна версія apiVersion
- **WHEN** клієнт передає `apiVersion`, несумісний із серверною версією контракту
- **THEN** сервер повертає типізовану помилку upgrade-required; апгрейд не завершується тихим behavioral-break
