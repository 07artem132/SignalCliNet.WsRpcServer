...
Порядок = залежності. Усі 8 — Фаза 2/3 плану.

| # | Change | Джерело в плані | Залежить від |
|---|---|---|---|
| 1 | `add-authz-chokepoint` | Phase-2 task-1, V8/V9, R3.2/R3.5/R3.6, A5 | task-0 (done) |
| 2 | `add-authn-token-pop` | Phase-2 task-2/4, D1/D7/D8/D10/G8, W18/W19/W21, C1-C4 | 1 |
| 3 | `add-admission-rate-limits` | Phase-2 task-5, W13/W16-рішення, G2/G3/G6, D2/D12 | 1 |
| 4 | `add-link-sessions` | Phase-2 task-6, D16+W9-рішення, G7 | 1, 2 |
| 5 | `add-invites-admin` | Phase-2 task-7/8/11, G5/G10/G12, R3.6/R3.8, M8 | 1, 2 |
| 6 | `add-group-claim-receive` | «Group-claim» + R3.1/R3.5, W20/W25 | 1, 2, 3 |
| 7 | `add-secure-deploy-persistence` | Phase-2 task-3/9, G1/G4, R3.4/R3.7, D17 | — (паралельно 1-6) |
